...
class RealSenseCamera(Camera):
    ...
    def _find_serial_number_from_name(self, name: str) -> str:
        ...
        print("**Found RealSense devices info:", found_devices) 
        ...
        #serial_number = str(found_devices[0]["serial_number"])   # add by zexuan
        serial_number = str(found_devices[0].get("serial_number", found_devices[0].get("id")))
