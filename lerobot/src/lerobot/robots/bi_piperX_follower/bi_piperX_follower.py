...
from ..piperX.config_piperX import PiperXConfig
from ..piperX.piperX import PiperXRobot
from .config_bi_piperX_follower import BiPiperXFollowerConfig


class BiPiperXFollower(Robot):
    """
    Bimanual PiperX follower robot composed of two single-arm PiperXRobot instances.

    This mirrors the design of BiPiperFollower: a thin wrapper that instantiates
    ...
    def __init__(self, config: BiPiperXFollowerConfig):
        ...
        self.left_arm = PiperXRobot(left_arm_config)
        self.right_arm = PiperXRobot(right_arm_config)
    ...
    def setup_motors(self) -> None:
        # PiperXRobot currently does not define a dedicated setup_motors;
    ...
    def get_observation(self) -> dict[str, Any]:
        ...
        for cam_key, cam in self.cameras.items():
            ...
            # Logging kept similar to BiPiperFollower, but without importing logger here.
